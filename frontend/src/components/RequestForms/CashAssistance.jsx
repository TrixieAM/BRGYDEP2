...
export default function CashAssistance() {
  ...
  // In the CashAssistance component, add these state variables
...
function handleSubmit() {
  ...
  if (!formData.full_name || !formData.address || !formData.sinceYear || !formData.request_reason) {
...
>
  ...
  <DialogContent sx={{ p: 3 }}>
    <Typography>
      This resident already has a valid Cash Assistance certificate issued on{' '}
